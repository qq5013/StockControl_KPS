...
{
    public partial class YSQueryControl :QueryConditonControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            YanShouManager manager = new YanShouManager();
            try
            {
                List<YanShouInfo> listData = manager.GetModelList(strWhereCondition);
        ...
        private void YSQueryControl_Load(object sender, EventArgs e)
        {
