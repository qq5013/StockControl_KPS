...
{
    public partial class ZDSJGJQueryControl :QueryConditonControl
    {
        public override event DelListArg ListLoadingEvent;
        private DeviceInfo thisdevice;
        public ZDSJGJQueryControl(DeviceInfo _deviceinfo)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                strWhereCondition = strWhereCondition + string.Format(" and p_gys like '%{0}%'", strGYSName);
            }
            ...
            GouJinManager manager=new GouJinManager();
            try
            {
        ...
        private void ZDSJGJQueryControl_Load(object sender, EventArgs e)
        {
