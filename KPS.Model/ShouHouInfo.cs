...
{
	/// <summary>
	/// 售后:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class ShouHouInfo
	{
        public ShouHouInfo()
		{}
		#region Model
        ...
        private bool _y_managertype = true;
        ...
        /// <summary>
        /// 处理类型(true:退货,false:换货)
        /// </summary>
        public bool y_managertype
        {
            set { _y_managertype = value; }
            get { return _y_managertype; }
        }
