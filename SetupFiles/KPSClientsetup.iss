...
AppId={{5157B5C4-B200-4ECB-A4E4-208B20476161}
AppName={#MyAppName}
...
OutputBaseFilename=医疗器械进销存管理系统_客户端
Compression=lzma
...
[CustomMessages]
chinesesimp.MyAppName=医疗器械进销存管理系统_客户端
chinesetrad.MyAppName=医疗器械进销存管理系统_客户端
