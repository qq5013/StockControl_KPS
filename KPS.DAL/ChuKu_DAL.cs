...
namespace KPS.DAL
{
	...
	/// 数据访问类:PSI_ChuKu
	/// </summary>
	public partial class ChuKu_DAL
	{
		public ChuKu_DAL()
		{}
		...
		public int GetMaxId()
		{
		return DbHelperOleDb.GetMaxID("ID", "PSI_ChuKu"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from PSI_ChuKu");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into PSI_ChuKu(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update PSI_ChuKu set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from PSI_ChuKu ");
			strSql.Append(" where ID=@ID");
			OleDbParameter[] parameters = {
					new OleDbParameter("@ID", OleDbType.Integer,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public KPS.Model.ChuKuInfo DataRowToModel(DataRow row)
		{
            KPS.Model.ChuKuInfo model = new KPS.Model.ChuKuInfo();
			if (row != null)
			{
