...
{
	/// <summary>
	/// 数据访问类:PSI_BuHeGePinJiLu
	/// </summary>
	public partial class BuHeGePinJiLu_DAL
	{
        public BuHeGePinJiLu_DAL()
		{}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from PSI_BuHeGePinJiLu");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into PSI_BuHeGePinJiLu(");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from PSI_BuHeGePinJiLu ");
			strSql.Append(" where ID=@ID");
			OleDbParameter[] parameters = {
					new OleDbParameter("@ID", OleDbType.Integer,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
        public KPS.Model.BuHeGePinJiLuInfo DataRowToModel(DataRow row)
		{
            KPS.Model.BuHeGePinJiLuInfo model = new KPS.Model.BuHeGePinJiLuInfo();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM PSI_BuHeGePinJiLu ");
			if(strWhere.Trim()!="")
			{
